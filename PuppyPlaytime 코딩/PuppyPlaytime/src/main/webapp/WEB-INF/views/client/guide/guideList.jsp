...
<script type="text/javascript">
	$(function(){
		...
		$("#fileImage").attr({
			src:"/image/roomPicture/${cageRoomVO.c_picture}",width:"275px",height:"100px"
		});
	});
</script>
						...
						<c:choose>
							<c:when test="${not empty roomList}">
								...
								<tr class="tac" data-num="${room.c_no}">
									...
									<c:if test="${!empty room.c_picture}">
										<td><a href='/client/guide/roomDetail?c_no=${room.c_no}'><img src="/image/roomImages/${room.c_picture}" width="100px" height="100px"/></a></td>
									</c:if>
										<td>${room.c_kind}</td>
