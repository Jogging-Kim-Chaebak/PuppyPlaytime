...
<script>
	function petInput(){
		$("#mypetForm").attr({
			"action" : "/client/reserve/petRegister",
			"method" : "post"
		});
	...
	<div class="row">
		<div class="col p-3" id="mypetInputForm">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="p_name" class="form-control" placeholder="이름을 입력해주세요." id="p_name" maxlength="10" value="${petVO.p_name}">
				</div>
  		  	</div>
				...
				<div class="col-sm-10">
					<input type="text" name="p_dogbreed" class="form-control" placeholder="견종을 입력해주세요." id="p_dogbreed" maxlength="15" value="${petVO.p_dogbreed }">
				</div>
  		  	</div>
			...
			<button type="button" class="btn btn-secondary" onclick="petInput()">입력하기</button>
			<button type="button" class="btn btn-secondary" onclick="petEdit()">수정하기</button>
			</form>
		</div>
