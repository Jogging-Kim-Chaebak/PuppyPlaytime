		...
		<div class="form-group">
			...
			<div class="form-floating mb-3">
				<span>*</span>약관 <input type="radio" id="m_required1"
					name="m_required1" value="y" />약관동의<br> <br>
				<textarea rows="15" cols="150"> 약관동의-puppy playtime  서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 네이버 서비스의 이용과 관련하여 puppy playtime  서비스를 제공하는 puppy playtime
...
셋째, 네이버 아이디를 이용한 부가 서비스 및 맞춤식 서비스 이용 또는 이벤트 응모 과정에서 해당 서비스의 이용자에 한해서만
 개인정보 추가 수집이 발생할 수 있으며, 이러한 경우 별도의 동의를 받습니다. </textarea>
				<br> <br> <input type="radio" id="m_required2"
					name="m_required2" value="y" />개인정보<br> <br>
				<textarea rows="15" cols="150">개인 정보 수집 및 이용 동의 -개인정보보호법에 따라 puppy playtime 에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적,
						  개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한  사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</textarea>
			</div>
			<div class="form-floating">
				<span class="required"></span>선택 <input type="checkbox"
					id="m_optional" name="m_optional" value="y" />이메일
		...
		<div class="form-group">
			<input type="submit" class="btn btn-primary"
				onclick="location.href='http://localhost:8080/client/login/login' " value="회원가입">
		</div>
	</form>
</body>
</html>